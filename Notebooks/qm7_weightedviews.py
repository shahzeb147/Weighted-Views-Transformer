...
def pendingties(pending,weight=1,oxyz=(False,False,False,False),tol=1e-14,carbonbased= True, not_hydrogen= False, heaviest_origin= False):
...
def structuretoviews(pending,viewlength= None,weight=1.,done=None,oxyz=(False,False,False,False),tol=1e-14,carbonbased= True, not_hydrogen= False, heaviest_origin= False):
...
def qm7filetowvmats(alist, speciesmap, carbonbased= True, not_hydrogen= False, heaviest_origin= True, viewlength=None):
    """
...
def load_qm7_data(mollist, speciesmap, setNatoms=None, setNviews=None, carbonbased= True, not_hydrogen= False, heaviest_origin= False,verbose=1):
    species = set()
